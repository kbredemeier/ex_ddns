defmodule ExDDNS.ConfigTest do
  ...
  describe "init/0 reads values from env" do
    setup do
      ...
      System.put_env("EX_DDNS_DOMAIN", "aaa")
      System.put_env("EX_DDNS_UPDATE_TIMEOUT", "9999")
      System.put_env("EX_DDNS_SERVICE", "Cloudflare")
  ...
  describe "init/0 value casting" do
    ...
    test "update_timeout" do
      System.put_env("EX_DDNS_UPDATE_TIMEOUT", "fooo")
      assert_raise RuntimeError, &Config.init/0
    end

    test "service" do
      System.put_env("EX_DDNS_SERVICE", "fooo")
      assert_raise RuntimeError, &Config.init/0
    end
  end
  ...
  test "init/0 raises an error if any value is missing" do
    ...
    System.put_env("EX_DDNS_DOMAIN", "")
    System.put_env("EX_DDNS_UPDATE_TIMEOUT", "")
    System.put_env("EX_DDNS_SERVICE", "")
